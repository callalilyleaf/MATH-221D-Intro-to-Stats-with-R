...
```{r}
old_faithful
mean(old_faithful$duration)
sd(old_faithful$duration)
...
A: The shape of the distribution of duration looks like a Bimodal distribution.
...
__Answer__:  58 and 82
# The middle 50% of wait times "data"
...
__Answer__:  0.8903637

__Question__: In your own words, explain what the standard deviation means in context of this problem:  
__Answer__:  Most of the replies of self-reported happiness score are within +-0.8 of 4.79, which shows most of the people from this group have a happiness score from 4 ~ 5.6
...
__Answer__:  A bell-shaped distribution since the histogram matches and the median value is very close to mean value.
