...
mean(big5$`Height in Inches`, na.rm=TRUE)
#na.rm
#na: The N/A values, rm: Remove

median(big5$`Height in Inches`, na.rm=TRUE)
sd(big5$`Height in Inches`, na.rm=TRUE)

favstats(big5$`Height in Inches`)
