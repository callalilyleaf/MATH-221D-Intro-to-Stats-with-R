...
__Answer__: The treatment group would be the one who review the materials at specific timing; the control group would be the one who don't review the materials.
...
__Answer__: Quantitative. Since the score (0-10) can be measured as numeric result, it's quantitative data.
...
__Study Type__: Observational Studies

2. Administering the tuberculosis vaccination to one group and giving a placebo to another

__Study Type__: Experiments


3. A mailed survey asking people whether or not they received the tuberculosis vaccine

__Study Type__: Observational Studies. Even though people received different shot, this study won't change anything nor provide different factors to the groups.
...
__Answer__:  The children who receive the vaccine


__Question__: What are the treatments?  
__Answer__:  The vaccine


__Question__: What is the population of this study?  
__Answer__:  The whole children body in the USA (or around the world)
...
__Data Type__: Quantitative 

2. The 3 most common brands of car found in the US

__Data Type__:  Categorical
...
__Answer__:  The whole people body who can vote.

__Question__:  What is the sample of the study?  
__Answer__:  The 2969 votes who responsed.
...
__Sampling Scheme__:  The simple random sample and stratified sample
__Explanation__: They firstly divided the students by their classes, which is stratified sampling. Then, they pick random samples from each class, which is simple random sampling. 
...
__Sampling Scheme__:  Systematic sample
__Explanation__:  They rolled the dice to choose what's the difference value between each sample, which is systematic sample. I don't know how they picked Albertson's from various grocery stores in Rexburg, which might include another sampling method.
...
__Answer__: I will use the cluster sample method. Divide the lake areas into several clusters, then use cluster sample to collect the pollutant data to maximize the efficiency.  
