...
Z-score: How many sd this data is far away from the median
...
__Answer__: 3 (which means 3*4 = 12. Your ACT score needs to be 12 points higher than the median)
...
# Equivalently:
pnorm(33, 21,4, lower.tail = FALSE) # Probability of normal distribution
```
...
pnorm(z)  # The area value LESS THAN the score (Left side)
1-pnorm(z) # The area value GREATER THAN the score (Right side)
